class Restaurante {
  ...
  String get tipoCulinaria =>
      _tipoCulinaria;

  set nomeRestaurante(String nome) {
    _nomeRestaurante = nome;
  }
  ...
  void exibirCategoriaCulinaria() {
    switch (_tipoCulinaria.toLowerCase()) {
      case 'japonesa':
        print(
          'Categoria: Culinária Asiática - '
          'Foco em peixes e arroz.',
        );
        break;

      case 'italiana':
        print(
          'Categoria: Massas e Pizzas artesanais.',
        );
        break;

      case 'brasileira':
        print(
          'Categoria: Churrasco, feijoada '
          'e pratos típicos.',
        );
        break;
      ...
      default:
        print(
          'Categoria: Culinária Internacional '
          'ou Diversa',
        );
    }
  }
